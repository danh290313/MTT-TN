...
public class CodeMsg {
	...
	public static CodeMsg UPLOAD_PHOTO_SUFFIX_ERROR = new CodeMsg(-6, "Định dạng ảnh không đúng!");
	...
	public static CodeMsg USER_REGISTER_TYPE_EMPTY = new CodeMsg(-1010, "Mục đích đăng ký Lagou không được để trống!");
	...
	public static CodeMsg COMPANY_FINANCE_SAVE_ERROR = new CodeMsg(-5017,
			"Lỗi khi lưu thông tin giai đoạn tài chính công ty! Vui lòng liên hệ quản trị viên!");
