    ...
    new Chart(b).Doughnut(c, d),
      ...
      100 == a
        ? $("#resumeScore .which span").html(
            '<a href="/home/position/list">Gửi nó ngay lập tức</a>'
          )
        : $("#resumeScore .which span").html("<a>Gửi nó ngay lập tức</a>");
  }
            ...
            $("#loadingImg").css("visibility", "hidden"),
              json.success
                ? ((html =
                    '<a href="' +
                    ctx +
                    '/nearBy/downloadResume" class="resume_download" title="下载' +
                    json.content.nearbyName +
                    '">' +
                    json.content.nearbyName +
                    "</a>" +
                    '<a  class="fr del" href="javascript:;">xóa bỏ</a><br /><span class="c9">上传时间：' +
                    json.content.time +
                    "</span>"),
  ...
  $(function () {
    ...
    function i() {
      $(".workForm").each(function () {
        $(this).validate({
          ...
          submitHandler: function (a) {
            var b =
                "请输入作品链接" != $('input[name="workLink"]', a).val()
    ...
    $(".profile_radio li input").click(function () {
        ...
        Edit: function () {
          "" == this.expectCityVal
            ...
            "" == this.expectSalaryVal
              ? ($("#expectSalary").val(""),
                $("#select_expectSalary").val("期望月薪").css("color", "#999"))
            ...
            ? (a.content[0].isDefault &&
              ...
              a.content[1].isDefault &&
                ...
                a.content[1].perfect ||
                  (b
                    .find(".setTip")
                    .text("在线简历还未达可投递标准，请完善后选择")
                    .show(),
                  b.find(".btn_profile_save").attr("disabled", "disabled"))),
              a.content[0].perfect ||
                a.content[1].perfect ||
                (b.find(".setTip").text("你还没有可投递的简历").show(),
                b.find(".btn_profile_save").attr("disabled", "disabled")),
      ...
      $("#myResume").on("click", ".resumeUploadDiv a.del", function () {
        confirm("你确定要删除该附件吗？删除后你设置的默认投递简历也将失效") &&
          $.ajax({ url: ctx + "/nearBy/delNearBy.json", type: "GET" }).done(
            function (a) {
              a.success
                ? ($("#myResume h2 a").html("上传简历"),
                  $("#myResume .resumeUploadDiv").html("暂无附件简历"))
                : alert(a.msg);
            }
          );
      });
