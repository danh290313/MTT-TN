					...
					<div class="c_detail">
						...
						<div class="c_box companyName">
							<#if Company??>
								...
								<div class="clear"></div>
								<h1 title="${Company.name}" class="fullname">
									${Company.name}
								</h1>
								<#else>
									...
									<div class="cp_intro">
										<#if Company??>
											<#if Company.productTitle??>
												<h3><a target="_blank" href="http://www.weimob.com">
							...
							<dd>
								<#if PositionList?size gt 0>
									<#list PositionList as position>
										<p><a href="/home/position/detail?id=${position.id!""}">
												<font size="3">
													${position_index+1}.${position.name!""}
											</a></font>
										</p>
									</#list>
								</#if>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<#if Company??>
												<#if Company.territory??>
													<a rel="nofollow" title="${Company.url!""}" href="javascript:void(0);">
														${Company.url!""}
													</a>
													<#else>
